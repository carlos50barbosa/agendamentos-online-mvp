...
const BUTTON_VARIANTS = {
  ...
  outline:
    'tw-border-slate-200 tw-bg-white tw-text-slate-700 hover:tw-bg-slate-50 focus-visible:tw-ring-slate-200',
  dangerOutline:
    'tw-border-rose-200 tw-bg-white tw-text-rose-700 hover:tw-bg-rose-50 focus-visible:tw-ring-rose-100',
  danger:
    'tw-border-rose-600 tw-bg-rose-600 tw-text-white tw-shadow-sm hover:tw-bg-rose-700 focus-visible:tw-ring-rose-100',
  warning:
