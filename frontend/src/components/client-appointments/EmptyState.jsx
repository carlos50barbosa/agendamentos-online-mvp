...
export default function EmptyState({
  ...
  return (
    <div className="tw-rounded-2xl tw-border tw-border-dashed tw-border-[color:var(--brand-border,#E7E5F5)] tw-bg-white tw-px-6 tw-py-10 tw-text-center tw-shadow-sm">
      <div className="tw-mx-auto tw-flex tw-h-14 tw-w-14 tw-items-center tw-justify-center tw-rounded-full tw-bg-brand-100 tw-text-brand">
