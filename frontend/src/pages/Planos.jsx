...
const PRICING_PLANS = [
  {
    ...
    features: [
      ...
      { key: 'starter-deposit', label: 'Sinal via PIX indisponível neste plano', tone: 'muted' },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'pro-deposit', label: 'Sinal via PIX (Asaas)' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'premium-deposit', label: 'Sinal via PIX (Asaas)' },
