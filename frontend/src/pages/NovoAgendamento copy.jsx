...
useEffect(() => {
  ...
  const performGuestBooking = useCallback(
    async ({ otpToken, manageLoading = true } = {}) => {
      ...
      try {
        ...
        await Api.publicAgendar(payload, { idempotencyKey: genIdempotencyKey() });
        await loadSlots();
        setState((p) => ({ ...p, selectedSlot: null }));
        setGuestModal((prev) => ({
          ...prev,
  ...
  }, [isAuthenticated, openGuestModal, showToast, validateBookingSelection]);  const handleFilterToggle = (filter) =>
