...
export const LEAD_TIME_BUCKETS = [ { key: '0-1d', label: '0-1d', minDays: 0, maxDays: 1, order: 1 }, { key: '2-3d', label: '2-3d', minDays: 2, maxDays: 3, order: 2 }, { key: '4-7d', label: '4-7d', minDays: 4, maxDays: 7, order: 3 }, { key: '8-14d', label: '8-14d', minDays: 8, maxDays: 14, order: 4 }, { key: '15+d', label: '15+d', minDays: 15, maxDays: null, order: 5 },
];
...
return {
date, confirmados: Number(row.confirmados || 0), cancelados: Number(row.cancelados || 0), concluidos: Number(row.concluidos || 0), no_show: Number(row.no_show || 0), receita_dia: Number(row.receita_centavos || row.receita_dia || 0), };
});
}
...
return {
...bucket, total: Number(row.total || 0), receita_centavos: Number(row.receita_centavos || 0), };
});
}
